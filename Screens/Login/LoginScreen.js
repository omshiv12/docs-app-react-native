        ...
        <View style={styles.secondContainer}>
          <ScrollView>
            ...
            <View style={styles.inStyle}>
              ...
              <TextInput value={username} keyboardType="phone-pad" onChangeText={handleUsername} style={{fontSize:20,width:'100%'}} placeholder="Mobile Number" placeholderTextColor="#555"/>
            </View>
            <View style={styles.inStyle}>
